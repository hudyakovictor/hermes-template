...
| Рабочий чат экипажа | `tools/crew.py`: ~85% — обсуждение работы, споры и взаимное ревью реальных косяков (ложные галочки, гниющие гипотезы, патентные кандидаты), ~15% — «шёпот» про заказчика; 0 GPU-часов, 0 токенов (`/chat`) |
