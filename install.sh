...
TG_CONCLAVE_THREAD="$(ask "  thread_id темы 'Conclave' (Enter = общий чат)" "")"
TG_DEBATE_THREAD="$(ask "  thread_id темы 'Дебаты' (Enter = Conclave)" "$TG_CONCLAVE_THREAD")"
TG_CLIENT_THREAD="$(ask "  thread_id темы 'Заказчик' (Enter = Conclave)" "$TG_CONCLAVE_THREAD")"
say "${DIM}  Conclave пишет наружу только короткие русские сообщения; reasoning остаётся внутри child.${OFF}"
...
say "  Conclave      : ${TG_CONCLAVE_THREAD:-—} | Дебаты ${TG_DEBATE_THREAD:-—} | Заказчик ${TG_CLIENT_THREAD:-—}"
...
umask 077
{
	...
	printf 'TELEGRAM_CONCLAVE_THREAD_ID=%s\n' "$TG_CONCLAVE_THREAD"
	printf 'TELEGRAM_DEBATE_THREAD_ID=%s\n' "$TG_DEBATE_THREAD"
	printf 'TELEGRAM_CLIENT_THREAD_ID=%s\n' "$TG_CLIENT_THREAD"
